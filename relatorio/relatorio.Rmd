...
Taxa de transferência (TR) = (valor mensurado na amostra cordão/ valor mensurado na amostra materna)*100.

### Associação entre dados numéricos
...
A tendência de associação foi observada usando a reta de regressão linear
