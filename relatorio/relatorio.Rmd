...
Os intervalos de confiança exatos das proporções foram calculados usando-se o pacote `exactci` (versão `r packageVersion("exactci")`), e a regressão de Deming foi calculada com o pacote `MethComp` (versão `r packageVersion("MethComp")`).
